...
/**
 * @file
 * Contains \Drupal\ctools\Routing\DisplayRouteSubscriberBase.
 */

namespace Drupal\ctools\Routing;
...
abstract class RouteSubscriber extends RouteSubscriberBase {
  ...
  protected function addAccessRoutes(RouteCollection $collection) {
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\AccessConditionAddForm',
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\AccessConditionEditForm',
        // @todo: '_title'
      ],
      $requirements,
      $options
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\AccessConditionDeleteForm',
        // @todo: '_title'
      ],
      $requirements,
      $options
  ...
  protected function addVariantRoutes(RouteCollection $collection) {
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\VariantPluginAddBlockForm',
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\VariantPluginEditBlockForm',
    ...
    $route = new Route(
      ...
      [
        '_form' => '\Drupal\ctools\Form\VariantPluginDeleteBlockForm',
  ...
  protected function addStaticContextRoutes(RouteCollection $collection) {
    ...
    $route = new Route(
      "{$path}/add",
      [
        '_form' => '\Drupal\ctools\Form\StaticContextAddForm',
    ...
    $route = new Route(
      "{$path}/delete",
      [
        '_form' => '\Drupal\ctools\Form\StaticContextDeleteForm',
  ...
  protected function addSelectionConditionRoutes(RouteCollection $collection) {
    ...
    $route = new Route(
      "{$path}/add/{condition_id}",
      [
        '_form' => '\Drupal\ctools\Form\SelectionConditionAddForm',
    ...
    $route = new Route(
      "{$path}/edit/{condition_id}",
      [
        '_form' => '\Drupal\ctools\Form\SelectionConditionEditForm',
        // @todo: '_title'
      ],
      $requirements,
      $options
    ...
    $route = new Route(
      "{$path}/delete/{condition_id}",
      [
        '_form' => '\Drupal\ctools\Form\SelectionConditionDeleteForm',
